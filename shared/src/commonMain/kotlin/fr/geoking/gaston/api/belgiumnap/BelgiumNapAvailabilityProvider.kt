...
/**
 * [BorneAvailabilityProvider] for Belgium NAP EV availability
 * (transportdata.be → Road Public Charging Network open dump).
 */
class BelgiumNapAvailabilityProvider(
    private val client: BelgiumNapAvailabilityClient,
