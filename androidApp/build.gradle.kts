...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        ...
        val chargyApiKey = sanitizeBuildConfigString(prop("CHARGY_API_KEY", "486ac6e4-93b8-4369-9c6a-28f7c4e1a81f"))
        val germanyTankerkoenigKey = sanitizeBuildConfigString(prop("GERMANY_TANKERKOENIG_KEY", "00000000-0000-0000-0000-000000000002"))
