...
configure<ApplicationExtension> {
    ...
    defaultConfig {
        ...
        val nobilApiKey = sanitizeBuildConfigString(prop("NOBIL_API_KEY"))
        val econtrolEvApiKey = sanitizeBuildConfigString(prop("ECONTROL_EV_API_KEY"))
        val econtrolEvRefererDomain = sanitizeBuildConfigString(prop("ECONTROL_EV_REFERER_DOMAIN"))
        val eipaExportKey = sanitizeBuildConfigString(prop("EIPA_EXPORT_KEY"))
        val revenueCatApiKey = sanitizeBuildConfigString(prop("REVENUECAT_API_KEY"))
        ...
        buildConfigField("String", "NOBIL_API_KEY", "\"$nobilApiKey\"")
        buildConfigField("String", "ECONTROL_EV_API_KEY", "\"$econtrolEvApiKey\"")
        buildConfigField("String", "ECONTROL_EV_REFERER_DOMAIN", "\"$econtrolEvRefererDomain\"")
        buildConfigField("String", "EIPA_EXPORT_KEY", "\"$eipaExportKey\"")
