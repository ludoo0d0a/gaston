...
class AutoPoiProviderSelectionScreen(
    ...
    private val options = listOf(
        ...
        PoiProviderType.AustraliaFuelWatch to "FuelWatch (WA Australia)",
        PoiProviderType.AustraliaPetrolSpy to "PetrolSpy (Australia)",
        PoiProviderType.SwitzerlandComparis to "Comparis (Switzerland)",
    ...
    override fun onGetTemplate(): Template {
        ...
        return ListTemplate.Builder()
            ...
            .setHeader(Header.Builder().setTitle(carContext.getString(R.string.screen_data_source)).setStartHeaderAction(Action.BACK).build())
            .build()
    }
}
