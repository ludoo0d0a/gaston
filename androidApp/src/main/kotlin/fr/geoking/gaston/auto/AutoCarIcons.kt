 ...
 */
object AutoCarIcons {
    private const val PRIMARY_LIGHT = 0xFF22C55E.toInt()
    private const val PRIMARY_DARK = 0xFF4ADE80.toInt()
...
fun CarContext.dashboardNetworkIcon(): CarIcon = carIcon(R.drawable.ic_poi_radar, AutoCarIcons.muted)
