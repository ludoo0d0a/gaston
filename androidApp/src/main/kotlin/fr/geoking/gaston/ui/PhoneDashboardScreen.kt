        ...
        Scaffold(
            ...
            LazyColumn(
                ...
                item {
                    ...
                    val cheapestTitle = remember(selectedSearchLocation) {
                        if (selectedSearchLocation != null) {
                            val placeName = selectedSearchLocation.city ?: selectedSearchLocation.label.split(",").first().trim()
                            "Cheapest near $placeName"
                        } else {
                            "Nearby cheapest"
                        }
                    }
