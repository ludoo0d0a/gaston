                ...
                actions = {
                    if (onPlanRoute != null || onLocatePlace != null || onRouteToDirection != null) {
                        Box {
                            ...
                            DropdownMenu(
                                ...
                                if (onPlanRoute != null) {
                                    DropdownMenuItem(
                                        text = { Text(stringResource(R.string.plan_route)) },
                                ...
                                if (onLocatePlace != null) {
                                    DropdownMenuItem(
                                        text = { Text(stringResource(R.string.locate_a_place)) },
                    ...
                    IconButton(onClick = onRefresh) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.refresh_map)
                        )
                    }
                    ...
                    IconButton(onClick = onShowSources) {
                        Icon(
                            ...
                            contentDescription = stringResource(R.string.data_sources)
                        )
                    }
